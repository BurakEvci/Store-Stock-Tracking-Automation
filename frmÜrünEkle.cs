...
namespace magaza1
{
    public partial class frmÜrünEkle : Form
    {
        ...
        private void barkodkontrol()
        {
            ...
            while (read.Read())
            {
                if (txtBarkodNo.Text==read["barkodno"].ToString() || txtBarkodNo.Text=="") //barkodNo veri tabanında varsa durumu false yap 
                {
                    durum = false;
                }
            }
        ...
        {
            comboBulunduguYer.Items.Add("Depo");
            comboBulunduguYer.Items.Add("Raf");
            kategorigetir();
        ...
        private void btnYeniEkle_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                SqlCommand komut = new SqlCommand("insert into urun(barkodno,kategori,marka,urunadi,miktari,alisfiyati,satisfiyati,yer,tarih) values(@barkodno,@kategori,@marka,@urunadi,@miktari,@alisfiyati,@satisfiyati,@yer,@tarih)", baglanti);
                ...
                komut.Parameters.AddWithValue("@yer", comboBulunduguYer.Text);
