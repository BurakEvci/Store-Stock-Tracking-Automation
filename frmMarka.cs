...
namespace magaza1
{
    public partial class frmMarka : Form
    {
        ...
        private void markakontrol()
        {
            ...
            while (read.Read())
            {
                if (comboBox1.Text==read["kategori"].ToString() && textBox1.Text == read["marka"].ToString() ||comboBox1.Text=="" || textBox1.Text == "") //kategori ve marka veri tabanında varsa durumu false yap 
                {
                    durum = false;
                }
            }
